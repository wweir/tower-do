...
check(
  ...
  formatGitSegment(0, 3) === "files 3 · dirty 0",
);
check(
  "segment: both viewpoints always labeled",
  formatGitSegment(3, 3) === "files 3 · dirty 3" &&
    formatGitSegment(8, 3) === "files 3 · dirty 8",
);
check(
...
check(
  ...
  formatGitSegment(8, 3, String, (s) => `[${s}]`) === "[files ]3[ · dirty ]8",
);
